...
void loop()
{
  ...
  delayMicroseconds(1); // Need 3ms delay before reading Device ID (otherwise first byte = 252)
  ...
  optic_flow_msg1.data = (signed char *)malloc(sizeof(signed char)*242); 
  ...
  optic_flow_msg2.data_length = 242; // THIS LINE IS CRUCIAL! 
                                  // https://answers.ros.org/question/37185/how-to-initialize-a-uint8multiarray-message/
                                  // https://answers.ros.org/question/10988/use-multiarray-in-rosserial/
  optic_flow_msg2.data = (signed char *)malloc(sizeof(signed char)*242); 
  ...
  optic_flow_msg3.data_length = 242; // THIS LINE IS CRUCIAL! 
                                  // https://answers.ros.org/question/37185/how-to-initialize-a-uint8multiarray-message/
                                  // https://answers.ros.org/question/10988/use-multiarray-in-rosserial/
  optic_flow_msg3.data = (signed char *)malloc(sizeof(signed char)*242); 
  ...
  optic_flow_msg4.data_length = 242; // THIS LINE IS CRUCIAL! 
                                  // https://answers.ros.org/question/37185/how-to-initialize-a-uint8multiarray-message/
                                  // https://answers.ros.org/question/10988/use-multiarray-in-rosserial/
  optic_flow_msg4.data = (signed char *)malloc(sizeof(signed char)*242); 
